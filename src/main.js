...
sort.addEventListener("click", () => {
  ...
  if (reversed) {
    ...
    sort.src = "/the-todos/sort2.png"; //använd denna ikon
  } else {
    //om inte (reverse är false, listan är uppifrån och ner)
    sort.src = "/the-todos/sort.png"; //använd denna ikon
  }
...
sort.src = reversed ? "/the-todos/sort2.png" : "/the-todos/sort.png"; //om reversed är true används första länken, om false används den andra länken
