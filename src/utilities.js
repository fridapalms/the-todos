export const createHtml = (todos) => {
  ...
  todos.forEach((todo, index) => {
    ...
    //ändra elementen
    checkbox.src = "/the-todos/unchecked.png"; //sätter bild på checkbox
